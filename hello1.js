 ...
 */  
  ...
  var getDecRatio = function (dictPartial) {
      return function (x) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 105, column 1 - line 111, column 1: " + [ x.constructor.name ]);
          })());
      };
  };
  var startStoping = function (dictPartial) {
      var infStop = function __do() {
          Control_Monad_Eff_Console.log("")();
          var upF = $foreign.getUpFlag(true);
          var oldSpeed = $foreign.getSpeed(0.0);
          var decSpeed = getDecRatio(dictPartial)(oldSpeed);
          var nS = (function () {
              var $39 = oldSpeed > 0.0;
              if ($39) {
                  return $foreign.setSpeed(oldSpeed - decSpeed);
              };
              return 0.0;
          })();
          (function () {
              ...
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Timer.setTimeout(1000)(infStop));
          })()();
          Data_Unit.unit;
          return Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showNumber)(oldSpeed) + ("   " + Data_Show.show(Data_Show.showNumber)(nS)))();
      };
      return function __do() {
          Data_Functor["void"](Control_Monad_Eff.functorEff)(infStop)();
  ...
  var main = function (dictPartial) {
      ...
      return function __do() {
          Data_Functor["void"](Control_Monad_Eff.functorEff)(startStoping(dictPartial))();
      ...
      return function (z) {
          return function __do() {
              ...
              return __unused(dictPartial)((function () {
                  ...
                  throw new Error("Failed pattern match at Main line 64, column 3 - line 65, column 3: " + [ v.constructor.name ]);
              })())();
          };
      };
  };
                  ...
                  return __unused(dictPartial)((function () {
                      if (v instanceof Data_Maybe.Just) {
                          return function __do() {
                              var v1 = Graphics_Canvas.getContext2D(v.value0)();
                              clearCanvas(v1)();
                              return Graphics_Drawing.render(v1)(scene(0.0)(0.0)(y)(0.0))();
                          };
                      };
                      throw new Error("Failed pattern match at Main line 44, column 3 - line 45, column 3: " + [ v.constructor.name ]);
                  })())();
              };
          };
      };
              ...
              return function (startM) {
                  return function (endM) {
                      ...
                      return function __do() {
                          ...
                          var ss = $foreign.setSpeed(speed / 10.0);
                          var direction = (v1.x - v.x) / $$Math.abs(v1.x - v.x) / 10.0;
                          ...
                          var rotateF = function (x) {
                              return function __do() {
                                  var v3 = Control_Monad_ST.readSTRef(v2)();
                                  funcX(dictPartial)(0.0)(x)();
                                  var newSpeed = Data_Maybe.fromMaybe(1)(Data_Int.fromNumber($$Math.trunc($foreign.getSpeed(0.0))));
                                  Control_Monad_Eff_Console.log("new Speed" + Data_Show.show(Data_Show.showInt)(newSpeed))();
                                  var zz = newSpeed > 0;
                                  if (zz) {
                                      var $53 = newSpeed > 2000;
                                      if ($53) {
                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Timer.setTimeout(1000 / 2000 | 0)(rotateF(x + direction)))();
                                      };
                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Timer.setTimeout(10000 / (180 * newSpeed | 0) | 0)(rotateF(x + direction)))();
                                  };
                                  return Data_Unit.unit;
                              };
                          };
          ...
          var downHandler = function (event) {
              return function (jq) {
                  return function __do() {
                      ...
                      var v6 = $foreign.setUpFlag(false);
                      ...
                      var upHandler = function (event1) {
                          return function (jq1) {
                              return function __do() {
                                  ...
                                  var v11 = $foreign.setUpFlag(true);
                                  Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showNumber)(v5) + ("   " + Data_Show.show(Data_Show.showNumber)(v10)))();
                                  infRotate(dictPartial)(v5)(v10)(v4)(v9)();
